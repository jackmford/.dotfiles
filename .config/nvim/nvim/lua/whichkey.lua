...
which_key.add({
  ...
  { "<leader>oo", "<cmd>OpenObsidian<cr>", desc = "Open Obsidian", nowait = true, remap = false},
  ...
  { "<leader>gg", "<cmd>FloatermNew --name=lazygit --height=0.9 --width=0.9 lazygit<CR>", desc = "Open Lazygit", nowait = true, remap = false },
  ...
  { "<leader>md", "<Plug>MarkdownPreviewToggle", desc = "Toggle Markdown Preview", nowait = true, remap = false },
  ...
  { "<leader>t", "<cmd>FloatermToggle<CR>", desc = "Toggle Terminal", nowait = true, remap = false },
